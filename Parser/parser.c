...
#define _loop0_21_type 1181
#define _gather_20_type 1182
#define _tmp_22_type 1183
#define _tmp_23_type 1184
#define _tmp_24_type 1185
#define _loop1_25_type 1186
#define _tmp_26_type 1187
#define _tmp_27_type 1188
#define _loop0_29_type 1189
#define _gather_28_type 1190
#define _loop0_31_type 1191
#define _gather_30_type 1192
#define _tmp_32_type 1193
#define _tmp_33_type 1194
#define _loop0_34_type 1195
#define _loop1_35_type 1196
...
#define _tmp_41_type 1202
#define _loop0_43_type 1203
#define _gather_42_type 1204
#define _loop0_45_type 1205
#define _gather_44_type 1206
#define _loop0_47_type 1207
#define _gather_46_type 1208
#define _loop0_49_type 1209
#define _gather_48_type 1210
#define _tmp_50_type 1211
#define _loop1_51_type 1212
#define _tmp_52_type 1213
#define _tmp_53_type 1214
#define _tmp_54_type 1215
#define _tmp_55_type 1216
#define _tmp_56_type 1217
#define _loop0_57_type 1218
#define _loop0_58_type 1219
#define _loop0_59_type 1220
...
#define _loop0_87_type 1248
#define _loop1_88_type 1249
#define _loop0_89_type 1250
#define _loop1_90_type 1251
#define _loop0_91_type 1252
#define _loop1_92_type 1253
#define _loop1_93_type 1254
#define _loop1_94_type 1255
#define _loop1_95_type 1256
#define _tmp_96_type 1257
#define _loop0_98_type 1258
#define _gather_97_type 1259
#define _tmp_99_type 1260
#define _tmp_100_type 1261
#define _tmp_101_type 1262
#define _tmp_102_type 1263
#define _loop1_103_type 1264
#define _tmp_104_type 1265
#define _tmp_105_type 1266
#define _loop0_107_type 1267
#define _gather_106_type 1268
#define _loop1_108_type 1269
#define _loop0_109_type 1270
#define _loop0_110_type 1271
#define _tmp_111_type 1272
#define _tmp_112_type 1273
...
import_from_as_names_rule(Parser *p)
{
    ...
    { // ','.import_from_as_name+
        ...
        asdl_seq * a;
        if (
            (a = _gather_36_rule(p))  // ','.import_from_as_name+
        )
        {
...
dotted_as_names_rule(Parser *p)
{
    ...
    { // ','.dotted_as_name+
        ...
        asdl_seq * a;
        if (
            (a = _gather_39_rule(p))  // ','.dotted_as_name+
        )
        {
...
with_item_rule(Parser *p)
{
    ...
    { // expression 'as' target &(',' | ')' | ':')
        ...
        if (
            ...
            &&
            _PyPegen_lookahead(1, _tmp_50_rule, p)
        )
        {
...
try_stmt_rule(Parser *p)
{
    ...
    { // 'try' ':' block except_block+ else_block? finally_block?
        ...
        if (
            ...
            (b = block_rule(p))  // block
            &&
            (ex = _loop1_51_rule(p))  // except_block+
            &&
            (el = else_block_rule(p), 1)  // else_block?
            &&
...
raise_stmt_rule(Parser *p)
{
    ...
    { // 'raise' expression ['from' expression]
        ...
        if (
            ...
            (a = expression_rule(p))  // expression
            &&
            (b = _tmp_53_rule(p), 1)  // ['from' expression]
        )
        {
...
func_type_comment_rule(Parser *p)
{
    ...
    { // NEWLINE TYPE_COMMENT &(NEWLINE INDENT)
        ...
        if (
            ...
            &&
            _PyPegen_lookahead(1, _tmp_56_rule, p)
        )
        {
...
parameters_rule(Parser *p)
{
    ...
    { // slash_no_default param_no_default* param_with_default* star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_57_rule(p))  // param_no_default*
            &&
            (c = _loop0_58_rule(p))  // param_with_default*
            &&
    ...
    { // param_with_default+ star_etc?
        ...
        void *b;
        if (
            (a = _loop1_62_rule(p))  // param_with_default+
            &&
...
star_etc_rule(Parser *p)
{
    ...
    { // '*' param_no_default param_maybe_default* kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_69_rule(p))  // param_maybe_default*
            &&
    ...
    { // '*' ',' param_maybe_default+ kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_70_rule(p))  // param_maybe_default+
            &&
            (c = kwds_rule(p), 1)  // kwds?
        )
        {
...
decorators_rule(Parser *p)
{
    ...
    { // (('@' named_expression NEWLINE))+
        ...
        asdl_seq * a;
        if (
            (a = _loop1_71_rule(p))  // (('@' named_expression NEWLINE))+
        )
        {
...
expressions_list_rule(Parser *p)
{
    ...
    { // ','.star_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_73_rule(p))  // ','.star_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_expressions_rule(Parser *p)
{
    ...
    { // star_expression ((',' star_expression))+ ','?
        ...
        if (
            ...
            &&
            (b = _loop1_75_rule(p))  // ((',' star_expression))+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_named_expressions_rule(Parser *p)
{
    ...
    { // ','.star_named_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_76_rule(p))  // ','.star_named_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_slash_no_default lambda_param_no_default* lambda_param_with_default* lambda_star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_79_rule(p))  // lambda_param_no_default*
            &&
            (c = _loop0_80_rule(p))  // lambda_param_with_default*
            &&
    ...
    { // lambda_param_with_default+ lambda_star_etc?
        ...
        void *b;
        if (
            (a = _loop1_84_rule(p))  // lambda_param_with_default+
            &&
...
lambda_star_etc_rule(Parser *p)
{
    ...
    { // '*' lambda_param_no_default lambda_param_maybe_default* lambda_kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_91_rule(p))  // lambda_param_maybe_default*
            &&
    ...
    { // '*' ',' lambda_param_maybe_default+ lambda_kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_92_rule(p))  // lambda_param_maybe_default+
            &&
            (c = lambda_kwds_rule(p), 1)  // lambda_kwds?
        )
        {
...
disjunction_rule(Parser *p)
{
    ...
    { // conjunction (('or' conjunction))+
        ...
        if (
            ...
            &&
            (b = _loop1_93_rule(p))  // (('or' conjunction))+
        )
        {
...
conjunction_rule(Parser *p)
{
    ...
    { // inversion (('and' inversion))+
        ...
        if (
            ...
            &&
            (b = _loop1_94_rule(p))  // (('and' inversion))+
        )
        {
...
comparison_rule(Parser *p)
{
    ...
    { // bitwise_or compare_op_bitwise_or_pair+
        ...
        if (
            (a = bitwise_or_rule(p))  // bitwise_or
            &&
            (b = _loop1_95_rule(p))  // compare_op_bitwise_or_pair+
        )
        {
...
for_if_clauses_rule(Parser *p)
{
    ...
    { // for_if_clause+
        ...
        if (
            (_loop1_108_var = _loop1_108_rule(p))  // for_if_clause+
        )
        {
...
kwargs_rule(Parser *p)
{
    ...
    { // ','.kwarg_or_starred+ ',' ','.kwarg_or_double_starred+
        ...
        asdl_seq * b;
        if (
            (a = _gather_113_rule(p))  // ','.kwarg_or_starred+
            &&
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _gather_115_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
    ...
    { // ','.kwarg_or_starred+
        ...
        if (
            (_gather_117_var = _gather_117_rule(p))  // ','.kwarg_or_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_starred+"));
    ...
    { // ','.kwarg_or_double_starred+
        ...
        if (
            (_gather_119_var = _gather_119_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_double_starred+"));
...
star_targets_rule(Parser *p)
{
    ...
    { // star_target ((',' star_target))* ','?
        ...
        if (
            (a = star_target_rule(p))  // star_target
            &&
            (b = _loop0_121_rule(p))  // ((',' star_target))*
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_targets_seq_rule(Parser *p)
{
    ...
    { // ','.star_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_122_rule(p))  // ','.star_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
del_targets_rule(Parser *p)
{
    ...
    { // ','.del_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_125_rule(p))  // ','.del_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
incorrect_arguments_rule(Parser *p)
{
    ...
    { // expression for_if_clauses ',' [args | expression for_if_clauses]
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_129_rule(p), 1)  // [args | expression for_if_clauses]
        )
        {
            D(fprintf(stderr, "%*c+ incorrect_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses ',' [args | expression for_if_clauses]"));
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions* ':' expression
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_loop0_130_var = _loop0_130_rule(p))  // star_named_expressions*
            &&
...
// _gather_36: import_from_as_name _loop0_37
static asdl_seq *
_gather_36_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // import_from_as_name _loop0_37
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_36[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "import_from_as_name _loop0_37"));
        alias_ty elem;
        asdl_seq * seq;
        if (
            (elem = import_from_as_name_rule(p))  // import_from_as_name
        ...
        D(fprintf(stderr, "%*c%s _gather_36[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "import_from_as_name _loop0_37"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _gather_39: dotted_as_name _loop0_40
static asdl_seq *
_gather_39_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // dotted_as_name _loop0_40
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_39[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "dotted_as_name _loop0_40"));
        alias_ty elem;
        asdl_seq * seq;
        if (
            (elem = dotted_as_name_rule(p))  // dotted_as_name
        ...
        D(fprintf(stderr, "%*c%s _gather_39[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "dotted_as_name _loop0_40"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop1_71: ('@' named_expression NEWLINE)
static asdl_seq *
...
// _gather_73: star_expression _loop0_74
static asdl_seq *
_gather_73_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_expression _loop0_74
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_73[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_expression _loop0_74"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_expression_rule(p))  // star_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_73[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_expression _loop0_74"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_77: ',' star_named_expression
static asdl_seq *
...
// _gather_76: star_named_expression _loop0_77
static asdl_seq *
_gather_76_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_named_expression _loop0_77
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_76[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_named_expression _loop0_77"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_named_expression_rule(p))  // star_named_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_76[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_named_expression _loop0_77"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_91: lambda_param_maybe_default
static asdl_seq *
...
// _loop1_92: lambda_param_maybe_default
static asdl_seq *
...
_gather_122_rule(Parser *p)
{
    ...
    { // star_target _loop0_123
        ...
        D(fprintf(stderr, "%*c> _gather_122[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_target _loop0_123"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_target_rule(p))  // star_target
        ...
        D(fprintf(stderr, "%*c%s _gather_122[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_target _loop0_123"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_125_rule(Parser *p)
{
    ...
    { // del_target _loop0_126
        ...
        D(fprintf(stderr, "%*c> _gather_125[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "del_target _loop0_126"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = del_target_rule(p))  // del_target
        ...
        D(fprintf(stderr, "%*c%s _gather_125[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "del_target _loop0_126"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_130: star_named_expressions
static asdl_seq *
